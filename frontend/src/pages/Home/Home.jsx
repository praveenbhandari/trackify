  ...
  return (
    <div >
      <Grid container sx={{ height: '95vh', width: '100%' }} spacing={2} justifyContent="center" alignItems="center" margin="auto" width="100%">
        <Grid item xs={6} sx={{ backgroundColor: '#326273', height: '100%', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
          <RegisterForm />
        </Grid>
        <Grid item xs={6} sx={{ height: '100%', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <img src={register} alt="register" style={{ height: "700px", width: "auto" }} />
        </Grid>
      </Grid>
    </div>
  )
