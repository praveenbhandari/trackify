        ...
        <div>
            <VerticalTimeline lineColor='black'>
                ...
                <VerticalTimelineElement
                    ...
                    contentStyle={{ background: '#E3655B', color: '#fff' }}
                    contentArrowStyle={{ borderRight: '7px solid  #E3655B' }}
                    date={manufacturedDate}
                    iconStyle={{ background: '#E3655B', color: '#fff' }}
                    icon={<HandymanIcon />}
                >
                    ...
                    stage == Constants.STAGE[1] || stage == Constants.STAGE[2] ?
                        product.retailers.map((retailer, index) =>
                            <VerticalTimelineElement
                                className="vertical-timeline-element--work"
                                date={releasedDate}
                                iconStyle={{ background: '#5B8C5A', color: '#fff' }}
                                contentStyle={{ background: '#5B8C5A', color: '#fff' }}
                ...
                {/* Customer  */}
                {
                    stage == Constants.STAGE[2] ?
                        <VerticalTimelineElement
                            ...
                            contentStyle={{ background: '#B57F50', color: '#fff' }}
                            iconStyle={{ background: '#B57F50', color: '#fff' }}
                            icon={<PersonIcon />}
                        >
